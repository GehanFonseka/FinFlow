                  ...
                  <tr key={item._id} className="hover:bg-gray-50">
                    <td className="px-3 sm:px-6 py-3 text-sm font-medium text-gray-900">
                      ...
                      <div className="sm:hidden text-xs text-gray-500 mt-1">
                        Budget: Rs. {item.price.toFixed(2)}
                      </div>
                    </td>
                    <td className="hidden sm:table-cell px-3 sm:px-6 py-3 text-sm text-gray-900 whitespace-nowrap">
                      ...
                      <div className="mt-1 h-2 w-full rounded-full bg-gray-200">
                        <div
                          className={`h-2 rounded-full ${
                            (item.usedAmount / item.price) * 100 > 100
                              ? "bg-red-600"
                              : "bg-[#25C935]"
                          }`}
                          style={{
                            width: `${Math.min(
                              (item.usedAmount / item.price) * 100,
                              100
                            )}%`,
                          }}
                        ></div>
                    ...
                    <td className="px-3 sm:px-6 py-3 text-sm font-medium whitespace-nowrap">
                      <span className={`${
