    ...
    <div>
      <div ref={componentRef} className="print-content p-3 sm:p-4">
        ...
        <div className="mt-6 sm:mt-10">
          <div className="py-3 text-[14px] sm:text-[16px] font-semibold bg-gray-50 px-3 sm:px-6 rounded-lg">
            Total Monthly Expense: Rs.{totalExpense.toFixed(2)}
          </div>
        </div>
              ...
              {data?.length > 0 ? (
                data.map((item) => (
                  <tr key={item._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 sm:px-6 py-3 text-sm text-gray-900 whitespace-nowrap">
